...
class SaveReviewTest extends TestCase
{
    ...
    #[Test]
    public function review_is_saved_if_valid_data_and_no_photos_are_submitted()
    {
        ...
        ])->postJson("/api/save-review/{$restaurant->external_id}", $data);
    ...
    #[Test]
    public function review_is_not_saved_if_invalid_data_is_submitted()
    {
        $restaurant = Restaurant::factory()->createOne();
        $data = [
    ...
    #[Test]
    public function review_cannot_be_saved_without_authentication()
    {
        auth()->logout();
        auth()->forgetUser();
